...
**Licence position for this dataset.** US federal regulations are government works, public domain. EU regulations as retained in UK law are published under Crown copyright with Open Government Licence. Facts (regulatory status, maximum levels) are not copyrightable in either jurisdiction.

---

Snapshot of [referencesource.org](https://referencesource.org/food-color-additive-status-us-vs-eu/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
