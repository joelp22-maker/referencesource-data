...
**377 records.** Canonical, always-current version: [https://referencesource.org/software-interface-version-compatibility/](https://referencesource.org/software-interface-version-compatibility/)
...
**Licence position for this dataset.** factual compilation of publicly documented version requirements

---

Snapshot of [referencesource.org](https://referencesource.org/software-interface-version-compatibility/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
