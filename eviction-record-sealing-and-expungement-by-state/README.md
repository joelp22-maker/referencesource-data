# Eviction record sealing and expungement by US state
...
**18 records.** Canonical, always-current version: [https://referencesource.org/eviction-record-sealing-and-expungement-by-state/](https://referencesource.org/eviction-record-sealing-and-expungement-by-state/)
...
| Records | 18 |
| Machine-readable | [`data.json`](data.json) · [changes feed](https://referencesource.org/eviction-record-sealing-and-expungement-by-state/changes.xml) |
...
Snapshot of [referencesource.org](https://referencesource.org/eviction-record-sealing-and-expungement-by-state/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
