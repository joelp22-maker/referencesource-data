...
**51 records.** Canonical, always-current version: [https://referencesource.org/state-section-179-bonus-depreciation-conformity/](https://referencesource.org/state-section-179-bonus-depreciation-conformity/)
...
**Licence position for this dataset.** State tax conformity positions are facts derived from state statutes and revenue department publications; not copyrightable. Sources are tax software support pages, CPA educational articles, and state revenue department publications.

---

Snapshot of [referencesource.org](https://referencesource.org/state-section-179-bonus-depreciation-conformity/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
