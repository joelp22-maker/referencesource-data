...
**13 records.** Canonical, always-current version: [https://referencesource.org/property-tax-appeal-deadlines-by-state/](https://referencesource.org/property-tax-appeal-deadlines-by-state/)
...
**Licence position for this dataset.** Facts extracted from state government pages; statutory deadlines are not copyrightable

---

Snapshot of [referencesource.org](https://referencesource.org/property-tax-appeal-deadlines-by-state/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
