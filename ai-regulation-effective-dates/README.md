# AI law and regulation effective dates by jurisdiction
...
**Licence position for this dataset.** Each record quotes one dating clause from an enacted bill, session law, or official journal and links to it. US federal and state statutes and the enrolled bills that make them are government edicts and are not subject to copyright (Banks v. Manchester; Georgia v. Public.Resource.Org, 2020). EU legislation published in the Official Journal is reusable under Commission Decision 2011/833/EU with source acknowledged. UK legislation on legislation.gov.uk is Crown copyright under the Open Government Licence v3.0. No instrument is reproduced in whole; what is taken is a fact plus a short attributed quote linking back.

---

Snapshot of [referencesource.org](https://referencesource.org/ai-regulation-effective-dates/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
