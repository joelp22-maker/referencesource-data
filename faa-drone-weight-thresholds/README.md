...
**5 records.** Canonical, always-current version: [https://referencesource.org/faa-drone-weight-thresholds/](https://referencesource.org/faa-drone-weight-thresholds/)
...
| Records | 5 |
| Machine-readable | [`data.json`](data.json) · [changes feed](https://referencesource.org/faa-drone-weight-thresholds/changes.xml) |
...
**Licence position for this dataset.** Federal regulatory and statutory text (14 CFR, 49 U.S.C.), a US government work, not copyrightable

---

Snapshot of [referencesource.org](https://referencesource.org/faa-drone-weight-thresholds/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
