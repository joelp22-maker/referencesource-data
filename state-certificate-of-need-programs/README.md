...
**Licence position for this dataset.** Facts extracted from NCSL's legislative overview of state certificate-of-need laws; whether a state operates a CON program, and the statutory citation for it, are facts and are not copyrightable

---

Snapshot of [referencesource.org](https://referencesource.org/state-certificate-of-need-programs/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
