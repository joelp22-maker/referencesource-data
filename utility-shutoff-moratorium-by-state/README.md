...
**10 records.** Canonical, always-current version: [https://referencesource.org/utility-shutoff-moratorium-by-state/](https://referencesource.org/utility-shutoff-moratorium-by-state/)
...
**Licence position for this dataset.** US state regulation / public agency order — facts not copyrightable (Feist, 1991)

---

Snapshot of [referencesource.org](https://referencesource.org/utility-shutoff-moratorium-by-state/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
