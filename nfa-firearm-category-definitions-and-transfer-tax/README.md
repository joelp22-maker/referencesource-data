...
**6 records.** Canonical, always-current version: [https://referencesource.org/nfa-firearm-category-definitions-and-transfer-tax/](https://referencesource.org/nfa-firearm-category-definitions-and-transfer-tax/)
...
**Licence position for this dataset.** Federal regulatory text (27 CFR) and Federal Register text, both US government works, not copyrightable

---

Snapshot of [referencesource.org](https://referencesource.org/nfa-firearm-category-definitions-and-transfer-tax/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
