...
**4 records.** Canonical, always-current version: [https://referencesource.org/dea-telemedicine-prescribing-flexibility-extensions/](https://referencesource.org/dea-telemedicine-prescribing-flexibility-extensions/)
...
**Licence position for this dataset.** Facts extracted from the Federal Register, a US government work not subject to copyright. Each record quotes a short verbatim span of the rule it describes and links back to that document on federalregister.gov.

---

Snapshot of [referencesource.org](https://referencesource.org/dea-telemedicine-prescribing-flexibility-extensions/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
