...
**857 records.** Canonical, always-current version: [https://referencesource.org/stihl-chainsaw-chain-and-bar-specs/](https://referencesource.org/stihl-chainsaw-chain-and-bar-specs/)

| | |
|---|---|
| Last verified | 2026-09-07 |
| Re-check due | 2028-09-06 |
| Records | 857 |
...
**Licence position for this dataset.** Fair use — factual manufacturer specifications assembled from certified Stihl dealer reference charts

---

Snapshot of [referencesource.org](https://referencesource.org/stihl-chainsaw-chain-and-bar-specs/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
