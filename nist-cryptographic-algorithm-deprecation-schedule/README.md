...
**21 records.** Canonical, always-current version: [https://referencesource.org/nist-cryptographic-algorithm-deprecation-schedule/](https://referencesource.org/nist-cryptographic-algorithm-deprecation-schedule/)
...
**Licence position for this dataset.** US government publication — public domain

---

Snapshot of [referencesource.org](https://referencesource.org/nist-cryptographic-algorithm-deprecation-schedule/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
