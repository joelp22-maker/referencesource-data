...
**2 records.** Canonical, always-current version: [https://referencesource.org/electrician-licence-progression-by-state/](https://referencesource.org/electrician-licence-progression-by-state/)
...
**Licence position for this dataset.** Facts extracted from the freely published licensing pages of state licensing authorities, with a short attributed quote and a link back. Licence requirements are public regulatory facts. No source page carries a restrictive notice.

---

Snapshot of [referencesource.org](https://referencesource.org/electrician-licence-progression-by-state/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
