...
**9 records.** Canonical, always-current version: [https://referencesource.org/cpa-licensure-pathway-by-state/](https://referencesource.org/cpa-licensure-pathway-by-state/)
...
Snapshot of [referencesource.org](https://referencesource.org/cpa-licensure-pathway-by-state/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
