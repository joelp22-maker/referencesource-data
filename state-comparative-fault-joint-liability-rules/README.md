...
**75 records.** Canonical, always-current version: [https://referencesource.org/state-comparative-fault-joint-liability-rules/](https://referencesource.org/state-comparative-fault-joint-liability-rules/)
...
Snapshot of [referencesource.org](https://referencesource.org/state-comparative-fault-joint-liability-rules/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
