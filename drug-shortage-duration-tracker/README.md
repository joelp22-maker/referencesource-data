...
**1,172 records.** Canonical, always-current version: [https://referencesource.org/drug-shortage-duration-tracker/](https://referencesource.org/drug-shortage-duration-tracker/)

| | |
|---|---|
| Last verified | 2026-09-09 |
| Re-check due | 2026-09-12 |
| Records | 1,172 |
