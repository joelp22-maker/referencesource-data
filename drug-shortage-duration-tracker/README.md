...
**1,173 records.** Canonical, always-current version: [https://referencesource.org/drug-shortage-duration-tracker/](https://referencesource.org/drug-shortage-duration-tracker/)
