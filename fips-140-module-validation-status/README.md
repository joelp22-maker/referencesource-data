...
**5,513 records.** Canonical, always-current version: [https://referencesource.org/fips-140-module-validation-status/](https://referencesource.org/fips-140-module-validation-status/)

| | |
|---|---|
| Last verified | 2026-09-13 |
| Re-check due | 2026-09-20 |
| Records | 5,513 |
