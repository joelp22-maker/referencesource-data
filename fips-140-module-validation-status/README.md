...
**5,515 records.** Canonical, always-current version: [https://referencesource.org/fips-140-module-validation-status/](https://referencesource.org/fips-140-module-validation-status/)

| | |
|---|---|
| Last verified | 2026-09-16 |
| Re-check due | 2026-09-23 |
| Records | 5,515 |
