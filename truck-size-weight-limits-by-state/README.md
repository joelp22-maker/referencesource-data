# Maximum legal vehicle size and weight limits by US state
...
**5 records.** Canonical, always-current version: [https://referencesource.org/truck-size-weight-limits-by-state/](https://referencesource.org/truck-size-weight-limits-by-state/)
...
Snapshot of [referencesource.org](https://referencesource.org/truck-size-weight-limits-by-state/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
