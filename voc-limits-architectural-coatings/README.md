...
**Licence position for this dataset.** Federal limits are US government work (public domain). State and regional limits are statutory/regulatory and not copyrightable. TBF Environmental is a freely published reference page.

---

Snapshot of [referencesource.org](https://referencesource.org/voc-limits-architectural-coatings/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
