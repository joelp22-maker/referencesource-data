...
**Licence position for this dataset.** US FDA regulations are US Government works, not copyrightable. EUR-Lex content is reusable under Commission Decision 2011/833/EU. Facts are not copyrightable (Feist, 1991); each record quotes a short attributed span and links back.

---

Snapshot of [referencesource.org](https://referencesource.org/food-additive-approval-status-us-vs-eu/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
