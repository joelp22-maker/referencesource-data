# SR-22 filing duration by US state — how long you must carry the certificate, quoted from the state DMV
...
**11 records.** Canonical, always-current version: [https://referencesource.org/sr22-filing-duration-by-state/](https://referencesource.org/sr22-filing-duration-by-state/)
...
Snapshot of [referencesource.org](https://referencesource.org/sr22-filing-duration-by-state/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
