...
**24 records.** Canonical, always-current version: [https://referencesource.org/record-retention-periods-federal/](https://referencesource.org/record-retention-periods-federal/)
...
Snapshot of [referencesource.org](https://referencesource.org/record-retention-periods-federal/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
