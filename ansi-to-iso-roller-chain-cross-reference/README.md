...
**10 records.** Canonical, always-current version: [https://referencesource.org/ansi-to-iso-roller-chain-cross-reference/](https://referencesource.org/ansi-to-iso-roller-chain-cross-reference/)
...
| Records | 10 |
| Machine-readable | [`data.json`](data.json) · [changes feed](https://referencesource.org/ansi-to-iso-roller-chain-cross-reference/changes.xml) |
...
**Licence position for this dataset.** Manufacturer catalog data; cite source, do not reproduce the whole table -- take the individual dimension facts and the attributed quote, not the document

---

Snapshot of [referencesource.org](https://referencesource.org/ansi-to-iso-roller-chain-cross-reference/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
