...
**96 records.** Canonical, always-current version: [https://referencesource.org/government-tort-claim-notice-deadlines-by-state/](https://referencesource.org/government-tort-claim-notice-deadlines-by-state/)
...
Snapshot of [referencesource.org](https://referencesource.org/government-tort-claim-notice-deadlines-by-state/), which is canonical and re-verified on a schedule. If a record here is wrong, that is worth more to us than one that is right — please open an issue.
